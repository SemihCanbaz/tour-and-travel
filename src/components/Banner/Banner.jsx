          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Discover the beauty and diversity of every corner of the
                  globe. From bustling cities to serene landscapes, we guide you
                  through the wonders of our planet. Whether you're an
                  experienced traveler or just beginning your journey, our
                  insights and tips are designed to enrich your adventures.
                  Embrace the thrill of exploration and let us be your companion
                  as you uncover the hidden gems and iconic destinations that
